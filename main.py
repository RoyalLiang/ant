...
from PySide6.QtWidgets import QApplication, QFileSystemModel, QFileDialog, QMessageBox, QMainWindow
...
class MainWindow(QMainWindow):
    ...
    def _show_message(self, *, title, message):
        ...
        message_box.setMinimumSize(300, 200)
        message_box.setMaximumSize(300, 200)
...
if __name__ == "__main__":
    ...
    widget.setWindowTitle("文件夹命名小工具")
